...
exports.updateUser = asyncHandler(async (req, res, next) => {
    ...
    if (checkuser(username, password, req.params.id)) {
        if (username === req.body.username) {
            ...
            return next(new ErrorResponse('Username cannot be updated', 400));
        }
    } else {
        return next(new ErrorResponse('User should be authenticated', 400));
    }
